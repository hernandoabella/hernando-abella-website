...
const NavigationButtons: React.FC<NavigationButtonsProps> = ({
  ...
  return (
    <>
      <motion.div
        className="flex flex-col md:flex-row md:flex-wrap gap-5 justify-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <Button className="w-full md:w-48" onClick={toggleServices}>
        ...
        <Button className="w-full md:w-48" onClick={toggleContactForm}>
